...
├── tools/
│   ├── test_store.js                    ٦٧ اختبارًا — node tools/test_store.js
...
```gradle
versionCode 17       // رقم صحيح يزيد دائمًا — أندرويد يمنع التحديث بدونه
versionName "2.6"    // ما يراه المستخدم
```
...
٦٧ اختبارًا، بلا أي حزم خارجية. الفكرة: تشغيل `app.js` **الحقيقي** داخل
